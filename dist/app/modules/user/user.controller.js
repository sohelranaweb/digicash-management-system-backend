...
const requestAgentRole = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const decodedToken = req.user;
    const user = yield user_service_1.UserServices.requestAgentRole(decodedToken.userId);
    (0, sendResponse_1.sendResponse)(res, {
        statusCode: 200,
        success: true,
...
const approveAgent = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const user = yield user_service_1.UserServices.approveAgent(userId);
    (0, sendResponse_1.sendResponse)(res, {
        statusCode: 200,
        success: true,
